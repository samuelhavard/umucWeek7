...
import authorization.SamuelHavardWeek7Fixed;
 ...
 */
public class SamuelHavardWeek7 extends javax.swing.JFrame {

    /**
     * Creates new form SamuelHavardWeek6
     */
    public SamuelHavardWeek7() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton1.setText("Launch Console");
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        DbConn dbconn = new DbConn(name, password);
        boolean access;
        ...
        try {
            ...
            Logger.getLogger(SamuelHavardWeek7.class.getName()).log(Level.SEVERE, null, e);
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            Logger.getLogger(SamuelHavardWeek7.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new SamuelHavardWeek7().setVisible(true);
        });
    }
